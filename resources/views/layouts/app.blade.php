    	    ...
    	    <div class="container">
    	      ...
    	      <div class="collapse navbar-collapse" id="ftco-nav">
    	        <ul class="navbar-nav ml-auto">
    	          ...
    	          <li class="nav-item cta"><a href="#" class="nav-link" class="btn btn-primary" data-toggle="modal" data-target="#exampleModal" data-whatever="@mdo"  onclick="validate()"><span >Login</span></a></li>
    	        </ul>
    	      </div>
    	    </div>
    	  </nav>
        ...
        <div class="modal-content">
          ...
          <div class="modal-body">
            <form action="{{URL::to('/login')}}" method="POST">
              ...
              <div class="form-group">
                <label for="message-text" class="col-form-label" name="user_password">Password:</label>
          ...
          <div class="modal-footer">
            <a href="/register1"> 	 <input type="button" class="btn btn-primary" type="submit" id="pp"
            value="Register"></a>
